...
function create() {
    ...
    mazee2 = [' ',
        ...
        'WTWCCCCCC            CCCCCCCWBWCCCCCCCCCCCCTCCCCCCCCCCCCC',
        'WCCCCCCCCCCCCCC  CC  CCCCCCC  CCCCCCCCCCCCCCCCCCCCCCCCC',
        'WCCCCCCTC   CCC  CC  CCCCCCC  CCCCCCTCCCCCCCCCCCCCCCCCC',
        'WCCCCCCCCCCCCCCCCCC  CCCCCCC  CCCCCCCCCCCCCTCCCCCCCCCCC',
        'WCCCCCCCC   CCCCCCC  CCCCCCC  CCCCCCCCCCCCCCCCCCCCCCCCC',
        'WCCCCCCCCCCCTCCCCCCC CCCCCCC  CCCCCCCCCCCCCCCCCCCCCCCCCCC',
        'WCCCCCCCC   CC    CC CCTCCCC  CCCCCCCCCCCCCCCCCCCCCCCCC',
        'WC  C CCCCCCCCCCCCC  CCCCCCC  CCCCCCCCCCCCCCTCCCCCCCCCC',
        'WC  C  CC    CCCCCC  CCCCCCC  CCCCCCCCCCCCCCCCCCCCCCCCC',
        'WCCCCCCTCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC',
        'WCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCTCCCCCCCCCCCCCCCCCC',
        'WCCCCCCCCCCCCCCTCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC',
        'WCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCTCCCCCCCCCCCCCC',
    ...
    maze2 = [ ' ',' ',
        ...
        '  WWWCCCCWWCCCCCCCCWW     WCCCCCCCCCCC',
    ...
    maze = [' ',
        'WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW ',
        '     V   WW   WWW   WWWWWWWWWWWWWWWWWWW    WWW   WW  V  V ',
    ...
    maze4 = [
        ' ',
        'IWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWI',
        'IWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWI',
        'IWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWI',
        'IWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWI',
        'IWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWI',
    ...
    if (maze3[i][j] === 'I') {
        const line = this.add.text(j * 20, i * 20, '│', {
            fontSize: '40px',
            fill: '#05f5f5',
            //fontFamily: 'Arial'
        }).setOrigin(0, 0).setScale(0.6);
