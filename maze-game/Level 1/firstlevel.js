...
function create() {
    ...
    maze2 = [ ' ',' ',
        '  WW    WWWWWCCCCWWWWW     WWCCCCCCWWW',
        '  WWWWCCCCCCBCCCC        WCCCCCWBWCCCC',
        '  WWWCCCCWCCCCBCCCCWW     WCCCCCCCBCCC',
        '  WCCBCWW     CCCCCCBCCCC      WWWTWWW',
        '  WCCCCCCBCCCCWWWWW      CCCCCCCCCCCCC',
        '  WWTCCCCC     WWBCCCCTCCCCC      WWWW',
        '  WWCCCCBCCCWCCBWW   B CCCCCCCCCCCCWWW',
        '  WWCCCCCCW     WWWWCBWCCCWWWBWCCCCWWW',
        '  WWWWCWWBWWWCCCCCWWWW    WWCWWBWWWWWW',
        '  WCCBCCWWWWW   B WBWCCCCCWCWWWW    WW',
        '  CCCCCCC   CCCCCCTCCCCCBCCC     CCBCC',
        '  CCCCBCCCCCBCCC     CCCCCBCCCCBWWWWWW',
        '  WW     CCCCWWWWCCCCCBCCCCCC     CCCC',
        '  WWCCCWWWBCCCCCC B   CWWBCCCBC     WW',
